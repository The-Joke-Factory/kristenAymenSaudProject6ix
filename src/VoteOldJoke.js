        ...
        return (
            <div className="randomOtherContainer">
                <form onSubmit={this.submitDate}>
                    <label htmlFor="getDate" >Choose a date</label>
                    <input id="getDate" onChange={this.getDate} type="date"/>
                    <button type="submit">Submit</button>
                    <button onClick={this.resetForm} type="reset">Back to Leaderboard</button>
                </form>
                {this.state.jokes.length === 0?<h2>No joke for this day, please select another day</h2>:<h2>Rate which jokes are best!</h2>}
